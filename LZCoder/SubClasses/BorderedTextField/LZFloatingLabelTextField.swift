//
//  LZFloatingLabelTextField.swift
//  LZCoder
//
 ...
 */
@IBDesignable
open class LZFloatingLabelTextField: UITextField { // swiftlint:disable:this type_body_length
    /**
    ...
    @IBInspectable dynamic open var titleColor: UIColor = UIColor(red:0, green:0, blue:0, alpha:1.0) {
        didSet {
            updateTitleColor()
        }
    }
    ...
    @IBInspectable dynamic open var lineColor: UIColor = UIColor(red:0, green:0, blue:0, alpha:1.0) {
        didSet {
            updateLineView()
        }
    }
    ...
    @IBInspectable dynamic open var disabledColor: UIColor = UIColor.darkGray {
        didSet {
            updateControl()
            updatePlaceholder()
        }
    ...
    @IBInspectable dynamic open var selectedTitleColor: UIColor = UIColor(red:0, green:0, blue:0, alpha:1.0) {
        didSet {
            updateTitleColor()
        }
    }
    ...
    @IBInspectable dynamic open var selectedLineColor: UIColor = UIColor(red:0, green:0, blue:0, alpha:1.0) {
        didSet {
            updateLineView()
        }
    }
    ...
    fileprivate func addEditingChangedObserver() {
        self.addTarget(self, action: #selector(LZFloatingLabelTextField.editingChanged), for: .editingChanged)
    }
